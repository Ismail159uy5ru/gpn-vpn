...
const Map<String, OrgIconData> organizationData = {
  ...
  "azure": OrgIconData(Icons.cloud_outlined, Color(0xFF0078D4)),
  "amazon": OrgIconData(Icons.cloud_outlined, Color(0xFFFF9900)),
  "oracle": OrgIconData(Icons.storage_outlined, Color(0xFFF80000)),
